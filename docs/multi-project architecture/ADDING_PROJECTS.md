...
Note: A concise, fast-start version of this guide is provided in `ADDING_PROJECTS_QUICK.md` (recommended for most additions). The rest of this file retains the detailed, step-by-step reference.
